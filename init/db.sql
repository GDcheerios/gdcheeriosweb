...
-- ==========================================
create sequence match_teams_id_seq
    as integer;

alter sequence match_teams_id_seq owner to postgres;
...
(
    ...
    primary_objective   text                     default 'total_score'::text not null,
    secondary_objective text                     default 'playcount'::text   not null
);
...
alter sequence match_teams_id_seq owned by teams.id;
...
create function set_match_ended_at() returns trigger
    language plpgsql
as
$$
BEGIN
...
alter function set_match_ended_at() owner to postgres;
...
execute procedure set_match_ended_at();
